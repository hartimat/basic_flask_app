...
# Page Name: awardtable.py
# Created: 4/30/2019
# Description: The awardtable.py program for Assignment #9.

from app import db_connect

input_csv_file = 'awards.csv'
...
with db_connect() as db:
	...
	for line in input_list:
		...
		sql = ''' INSERT INTO nominees(nominee_title, description, name_of_image_file, current_votes) VALUES (?, ?, ?, ?)'''
